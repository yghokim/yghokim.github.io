...
export default function ResourcesPage(){
    ...
    return <>
        <MainPanel withFixedSidebar>
            ...
            <Link href="/assets/younghokim-portrait-2023.jpg" className="block mt-4">
                <Image src="/assets/younghokim-portrait-2023.jpg" width={900} height={900} alt="Portrait of Young-Ho Kim" className="w-1/4 min-w-[200px]"/>
